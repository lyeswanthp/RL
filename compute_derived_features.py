...
def main():
    ...
    # Final summary
    logger.info("\n" + "=" * 80)
    logger.info("DERIVED FEATURES COMPUTATION COMPLETE")
    logger.info("=" * 80)

    logger.info("""
Features Added:
  1. PaO2_FiO2    - Oxygenation ratio (respiratory function)
  2. Shock_Index  - HR/SysBP (hemodynamic stability indicator)
  3. SOFA         - Sequential Organ Failure Assessment (5-component)

SOFA Components:
  - sofa_respiration     (from PaO2_FiO2)
  - sofa_coagulation     (from Platelets_count)
  - sofa_liver           (from Total_bili)
  - sofa_cardiovascular  (from MeanBP + max_dose_vaso)
  - sofa_cns             (GCS missing - assumed normal = 0)
  - sofa_renal           (from Creatinine)

Note: SOFA ranges 0-20 (instead of 0-24) due to missing GCS.
This is clinically acceptable and widely used in practice.

Next Steps:
  1. Extract actions: python extract_actions.py
  2. Build MDP trajectories
